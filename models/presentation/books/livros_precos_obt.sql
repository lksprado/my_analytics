...
final AS (
    SELECT
        ...
        t3.ano,
        t3.mes_do_ano                                              AS mes,
        t3.mes_sk,
        LOWER(t3.nome_mes)                                         AS nome_mes,
        t3.semana_iso_do_ano                                       AS semana_iso,
        LOWER(t3.nome_dia_semana)                                  AS nome_dia_semana,
        t3.fl_dia_util,
