...
renamed AS (
    SELECT
        ...
        identificacaoparlamentar_codigopubliconalegatual::BIGINT                        AS codigo_publico_na_leg_atual,
        ...
        identificacaoparlamentar_bloco_codigobloco::BIGINT                              AS bloco_codigo_bloco,
        ...
        mandato_codigomandato::BIGINT                                                   AS mandato_codigomandato,
        mandato_ufparlamentar,
        mandato_primeiralegislaturadomandato_numerolegislatura::BIGINT
                                                                                        AS mandato_primeiralegislaturadomandato_numerolegislatura,
        mandato_segundalegislaturadomandato_numerolegislatura::BIGINT
                                                                                        AS mandato_segundalegislaturadomandato_numerolegislatura,
        mandato_descricaoparticipacao,
        mandato_suplentes_suplente,
        mandato_exercicios_exercicio,
        TO_DATE(identificacaoparlamentar_bloco_datacriacao::TEXT, 'YYYYMMDD')
                                                                                        AS identificacaoparlamentar_bloco_datacriacao,
        TO_DATE(mandato_primeiralegislaturadomandato_datainicio::TEXT, 'YYYYMMDD')
                                                                                        AS mandato_primeiralegislaturadomandato_datainicio,
        TO_DATE(mandato_primeiralegislaturadomandato_datafim::TEXT, 'YYYYMMDD')
                                                                                        AS mandato_primeiralegislaturadomandato_datafim,
        TO_DATE(mandato_segundalegislaturadomandato_datainicio::TEXT, 'YYYYMMDD')
                                                                                        AS mandato_segundalegislaturadomandato_datainicio,
        TO_DATE(mandato_segundalegislaturadomandato_datafim::TEXT, 'YYYYMMDD')
                                                                                        AS mandato_segundalegislaturadomandato_datafim,
        NULLIF(mandato_titular_descricaoparticipacao, 'NAN')
                                                                                        AS mandato_titular_descricaoparticipacao,
