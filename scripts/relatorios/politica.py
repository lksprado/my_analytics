...
`models/presentation/financas/_docs_financas.md`. O Markdown é a fonte de verdade —
...
TEXTO_CAMADA = {
    ...
    "CRESCIMENTO": "Acumulação de patrimônio no longo prazo, aceitando volatilidade. Horizonte de cinco anos ou mais.",
...
TEXTO_CATEGORIA = {
    ...
    "educacao": "Cursos, graduação e pós-graduação, certificações, livros, material didático e plataformas de ensino.",
}
